...
import CoinProgressModal from '@/components/CoinProgressModal';
                    ...
                    >
                        ...
                        <DropdownMenu.Item asChild>
                            <button
                                ...
                                className="w-full flex items-center gap-3 px-4 py-2.5 rounded-md text-sm font-medium transition-colors cursor-pointer outline-none font-outfit text-left"
                                style={{
                                    color: '#333',
                                }}
                                onMouseEnter={(e) => {
                            ...
                            >
                                <TrendingUp className="w-4 h-4" style={{ color: '#CD5656' }} />
                                <span>Progress</span>
                            </button>
                        </DropdownMenu.Item>
