...
const UnlockFeatures: React.FC<UnlockFeaturesProps> = ({ 
    ...
    return (
        <div 
            className="rounded-2xl p-4 sm:p-6 transition-all duration-300 font-outfit relative overflow-hidden h-full"
            style={{
        ...
        >
            ...
            <div className="relative z-10">
                <div className="flex items-center gap-2 mb-3 sm:mb-4">
                    <Sparkles className="w-4 h-4 sm:w-5 sm:h-5" style={{ color: '#CD5656' }} />
                    <h3 
                ...
                <div className="flex items-center gap-2 mb-4 sm:mb-6 p-2 sm:p-3 rounded-lg" style={{ backgroundColor: 'rgba(255, 255, 255, 0.5)' }}>
                    <Files className="w-3 h-3 sm:w-4 sm:h-4 flex-shrink-0" style={{ color: '#CD5656' }} />
                    <span 
                ...
                <button
                    className="w-full flex items-center justify-center gap-2 px-3 sm:px-4 py-2 sm:py-3 rounded-lg text-xs sm:text-sm font-semibold transition-all hover:opacity-90 cursor-pointer"
                    style={{
